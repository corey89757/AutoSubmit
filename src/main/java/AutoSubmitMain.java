...
//        System.out.println(httpResponse.body());
        ...
        hashMap.put("PdbSearchForm[name]", pdbName);
        hashMap.put("PdbSearchForm[_token]", pdbSearchFormToken);
        httpResponse = HttpRequest.post("https://soft.dezyme.com/pdb/search.json")
                .header("Cookie", cookieName + "=" + cookieValue)
                .form(hashMap)
                .execute();
//        System.out.println(httpResponse.body());
